    ...
    public static readonly presetCategories: DictionaryArray<PresetCategory> = toNameMap([
        ...
        },
        {
            name: "Bass Presets", presets: <DictionaryArray<Preset>>toNameMap([
                ...
                { name: "C64 Bass", midiProgram: 80, settings: {"type":"PWM","volume":0,"eqFilter":[{"type":"high-pass","cutoffHz":105.11,"linearGain":0.5},{"type":"low-pass","cutoffHz":5656.85,"linearGain":2}],"eqFilterType":false,"eqSimpleCut":10,"eqSimplePeak":0,"envelopeSpeed":12,"discreteEnvelope":false,"eqSubFilters0":[{"type":"high-pass","cutoffHz":105.11,"linearGain":0.5},{"type":"low-pass","cutoffHz":5656.85,"linearGain":2}],"effects":["panning"],"pan":0,"panDelay":10,"fadeInSeconds":0,"fadeOutTicks":-1,"unison":"none","pulseWidth":50,"decimalOffset":0,"envelopes":[{"target":"pulseWidth","envelope":"twang","inverse":true,"perEnvelopeSpeed":15,"perEnvelopeLowerBound":0,"perEnvelopeUpperBound":1},{"target":"noteVolume","envelope":"twang","inverse":false,"perEnvelopeSpeed":10,"perEnvelopeLowerBound":0,"perEnvelopeUpperBound":1.5}],"isDrum":false} },
            ]),
        },
